...
PacientesDAO.prototype.editarPaciente = function(Paciente, callback){
    this._connection.query( "UPDATE Pacientes set NomePaciente='"+Paciente.NomePaciente +"' , StatusPaciente='"+Paciente.StatusPaciente +"' , CPFPaciente='"+Paciente.CPFPaciente +"' , RGPaciente='"+Paciente.RGPaciente +"' ,TelefonePaciente='"+Paciente.TelefonePaciente +"' , EnderecoPaciente='"+Paciente.EnderecoPaciente +"' , BairroPaciente='"+Paciente.BairroPaciente +"' , CidadePaciente='"+Paciente.CidadePaciente +"' , EstadoPaciente='"+Paciente.EstadoPaciente +"' , PaisPaciente='"+Paciente.PaisPaciente +"' WHERE IDPaciente='"+Paciente.IDPaciente+"'" , callback );  
}
