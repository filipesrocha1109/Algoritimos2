...
LocaisDAO.prototype.salvarLocal = function(local, callback){
    ...
    this._connection.query( "UPDATE locaisatendimento  set NomeLocal='"+local.NomeLocal +"' NumeroLeitos='"+local.NumeroLeitos +"' NumeroLeitosDisponiveis='"+local.NumeroLeitosDisponiveis +"' TelefoneLocal='"+local.TelefoneLocal +"' TelefoneLocalOp='"+local.TelefoneLocalOp +"' EmailLocal='"+local.EmailLocal +"' EnderecoLocal='"+local.EnderecoLocal +"' NumeroLocal='"+local.NumeroLocal +"' CepLocal='"+local.CepLocal +"' BairroLocal='"+local.BairroLocal +"' CidadeLocal='"+local.CidadeLocal +"' EstadoLocal='"+local.EstadoLocal +"' PaisLocal='"+local.PaisLocal +"' WHERE IDLocal='"+local.IDLocal+"'" , callback ); 
}
